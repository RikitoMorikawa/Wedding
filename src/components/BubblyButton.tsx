...
const BubblyButton = forwardRef<HTMLButtonElement, BubblyButtonProps>(({ children, variant = "primary", className = "", ...props }, ref) => {
  const baseStyles = variant === "primary" ? "bubbly-button" : "bubbly-button-secondary";
    ...
    <>
      ...
      <style jsx>{`
        ...
        .bubbly-button-secondary {
          ...
          position: relative;
          transition: transform ease-in 0.1s, box-shadow ease-in 0.25s;
          box-shadow: 0 2px 25px rgba(107, 114, 128, 0.3);
          width: 100%;
          font-weight: bold;
        }

        .bubbly-button-secondary:hover {
